...
func TestCompile_EndToEnd(t *testing.T) {
	testCases := []struct {
		...
		// },
		// {
		// 	name: "setext heading: indented dash underline after paragraph text forms level 2 heading",
		// 	md: `hello
		//  ---`,
		// },
		// {
		// 	name: "setext heading: indented equals underline after paragraph text forms level 1 heading",
		// 	md: `hello
		//  ===`,
		// },
		// {
		...
		// },
		// {
		// 	name: "setext heading: setext heading followed by paragraph",
		// 	md: `hello
		// -----
		//
		// world`,
		// },
		// {
		// 	name: "setext heading: immediately preceding paragraph line becomes heading text",
		// 	md: `world
		// -----`,
		// },
		// {
